...
void doProgrammerSkills(){
	writeDebugStreamLine("(%s,%d): Entering doProgrammerSkills routine",__FILE__,__LINE__);

	writeDebugStreamLine("(%s,%d): Exiting doProgrammerSkills routine",__FILE__,__LINE__);
